...
| `gifmaker/media.py` | Media probing, URL validation/import and progress reporting, FFmpeg command construction, exports, size targeting, frame editing, loop generation, and temporary asset storage. |
